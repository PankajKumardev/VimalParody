...
const Box = () => {
  return (
    <div className='flex bg-orange-100 rounded-lg px-4 mt-4 h-56 ml-4 mr-4'>
        <div className=' '>
        <Image src={Vimal} alt="Vimal"  height={265} width={222} 
     className="h-full w-full object-contain sticky top-0 right-0"/>
        </div>
